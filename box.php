                ...
                <section class="site-section">
                    ...
                    <table class="table table-responsive table-striped table-hover">
                        <tr>
                            ...
                            <td class="table-data"><?php echo $_SERVER['SERVER_ADDR']; ?></td>
                            <td><i class="fa fa-check"></i></td>
                        </tr>
                        <tr>
                            <td><strong>myLocal</strong></td>
                            <td class="table-data">https://<?php echo $_SERVER['HTTP_HOST']; ?>
                                <br>
                        ...
                        <tr><td><strong>Links</strong></td>
                            <td>
                                <a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/info.php" target="_blank">
                                    <strong>info</strong>
                                </a> |
                                <a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/wp-admin/" target="_blank">
                                    <strong>dashboard</strong>
                                </a> |
                                <a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/" target="_blank">
                                    <strong>front</strong>
                                </a> |
                                <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>.<?php echo $_SERVER['SERVER_ADDR']; ?>.xip.io/box.php<?php echo $_SERVER['HTTP_HOST']; ?>" target="_blank">
                    ...
                    <table class="table table-responsive table-striped table-hover">
                        <tr>
                            <th>
                                ...
                                <code>>> ssh vagrant@<?php echo $_SERVER['SERVER_ADDR']; ?> </code>
                            </th>
                        </tr>
                        <tr>
                            <td>
                                <div class="credentials">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="127.0.0.1 or <?php echo $_SERVER['SERVER_ADDR'];?>">
                                    </div>
                                    <div class="form-group">
